...
<form class="form-horizontal" role="form" name="frm">	
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body">		
			<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-category-banner">
				<thead>
					<tr>
...
<script type="text/javascript" language="javascript">	
	...
	function getList() {  	
		...
		$.ajax({
			...
			success: function (data, status, jqXHR) {  
				...
				vCategoryBannerTable.clear().draw();
				vCategoryBannerTable.rows.add(data).draw();
				spinner.hide();
			},
	...
	function checkWithList(this_checkbox){
		var dr = vCategoryBannerTable.row( $(this_checkbox).closest('tr') ).data();       		
		...
		vCategoryBannerTable.row( $(this_checkbox).closest('tr') ).data(dr);
	}	
	function updateStatus(status){		
		var token 	= 	$('input[name="_token"]').val();   
		var dt 		= 	vCategoryBannerTable.data();
		var str_id	=	"";		
		...
		$.ajax({
			...
			success: function (data, status, jqXHR) {   							                              				
				showMsg('note',data);               		
				vCategoryBannerTable.clear().draw();
				vCategoryBannerTable.rows.add(data.data).draw();
				spinner.hide();
			},
			beforeSend  : function(jqXHR,setting){
				spinner.show();
