...
<form class="form-horizontal" role="form" name="frm">	
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body">		
			<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-employer">
				<thead>
					<tr>
...
<script type="text/javascript" language="javascript">	
	...
	function getList() {  	
		...
		$.ajax({
			...
			success: function (data, status, jqXHR) {  								
				...
				vEmployerTable.rows.add(data).draw();
				spinner.hide();
			},
	...
	function checkWithList(this_checkbox){
		var dr = vEmployerTable.row( $(this_checkbox).closest('tr') ).data();       		
		...
		vEmployerTable.row( $(this_checkbox).closest('tr') ).data(dr);
	}	
