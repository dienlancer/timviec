...
$linkUpdateStatusToShow	=	route('adminsystem.'.$controller.'.updateStatus',[1,@$menu_type_id]);
$linkUpdateStatusToHide =	route('adminsystem.'.$controller.'.updateStatus',[0,@$menu_type_id]);
$linkTrash				=	route('adminsystem.'.$controller.'.trash',[@$menu_type_id]);
$linkSortOrder			=	route('adminsystem.'.$controller.'.sortOrder',[@$menu_type_id]);
?>
