            ...
            success: function (data) {
                if(data.checked==1){
                    ...
                    if(typeof data_error.sort_order               != "undefined"){
                        $('input[name="main_sort_order"]').closest('.form-group').addClass(data_error.sort_order.type_msg);
                        $('input[name="main_sort_order"]').closest('.form-group').find('span').text(data_error.sort_order.msg);
                        $('input[name="main_sort_order"]').closest('.form-group').find('span').show();                        
                    }
