...
<form class="form-horizontal" role="form" name="frm">	
	...
	<div class="portlet light bordered">
		...
		<div class="portlet-body">		
			<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-sex">
				<thead>
					<tr>
...
<script type="text/javascript" language="javascript">	
	...
	function checkWithList(this_checkbox){
		var dr = vSexTable.row( $(this_checkbox).closest('tr') ).data();       		
		...
		vSexTable.row( $(this_checkbox).closest('tr') ).data(dr);
	}	
