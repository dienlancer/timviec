	...
	<div class="portlet light bordered">
		...
		<div class="row">
                <div class="col-md-8">
                    ...
                    <div><?php echo $ddlCategoryVideo ; ?></div>
                </div>                                    
                <div class="col-md-4">
                    <div>&nbsp;</div>
                    <div>
		...
		<div class="portlet-body">		
			<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-video">
				<thead>
					<tr>
...
<script type="text/javascript" language="javascript">	
	...
	function getList() {  	
		...
		$.ajax({
			...
			success: function (data, status, jqXHR) {  				
				...
				vVideoTable.rows.add(data).draw();
				spinner.hide();
			},
	...
	function checkWithList(this_checkbox){
		var dr = vVideoTable.row( $(this_checkbox).closest('tr') ).data();       		
		...
		vVideoTable.row( $(this_checkbox).closest('tr') ).data(dr);
	}	
