...
<div class="wrapper-register">
	...
	<div class="login_section">
		<!-- login_form_wrapper -->
		<form name="frm-employer-login" method="POST" enctype="multipart/form-data" class="login_form_wrapper">
			{{ csrf_field() }}
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<!-- login_wrapper -->
						<h1>ĐĂNG NHẬP TÀI KHOẢN NHÀ TUYỂN DỤNG</h1>
						<div class="login_wrapper">
							...
							<div class="login_remember_box">
								...
								<a href="<?php echo route('frontend.index.resetPassWrdEmployer'); ?>" class="forget_password">
									Quên mật khẩu
								</a>
							</div>
							<div class="login_btn_wrapper">
								<a href="javascript:void(0);" onclick="document.forms['frm-employer-login'].submit();" class="btn btn-primary login_btn">ĐĂNG NHẬP</a>
							</div>
							<div class="login_message">
								<p>Bạn không có tài khoản ? <a href="<?php echo route('frontend.index.employerRegister'); ?>">Đăng ký tài khoản nhà tuyển dụng</a> </p>
							</div>
						</div>						
						<!-- /.login_wrapper-->
					</div>
